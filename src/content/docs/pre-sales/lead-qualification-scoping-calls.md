---
title: Lead Qualification & Scoping Calls
description: How to qualify a lead, run a productive scoping call, and decide whether to invest proposal effort.
type: sub-section
phase: pre-sales
order: 2
tree: "process"
...
:::tip
Ask "what happens if this doesn't get done by [their stated deadline]?" early in the call. The answer tells you whether the timeline is aspirational or load-bearing. Load-bearing timelines indicate real urgency; aspirational ones often disappear when you push back on scope.
:::

:::caution
Never take a scoping call without pre-call research. Arriving unprepared signals that you treat their business as a commodity. Even 20 minutes on their website and LinkedIn is enough to ask specific, credible questions.
:::
