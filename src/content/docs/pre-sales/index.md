...
description: How agency engagements begin — qualifying leads, writing proposals, drafting SOWs, and committing to price.
type: phase-overview
phase: pre-sales
order: 1
...
Cross-phase context: Pre-Sales hands off directly to [Discovery](/discovery/), where the signed SOW becomes the mandate for detailed requirements work. Repeat clients re-enter Pre-Sales from [Maintenance & Retainer](/maintenance-retainer/) when they want to expand scope or start a new engagement.
...
:::tip
Write the desired outcomes section of your proposal before you write anything else. If you cannot articulate what "done" looks like for the client in two sentences, you do not yet understand the engagement well enough to price it.
:::

:::caution
Do not start any design, architecture, or development work before the SOW is signed. "We'll get the paperwork sorted later" is how scope creep starts on day one.
:::
