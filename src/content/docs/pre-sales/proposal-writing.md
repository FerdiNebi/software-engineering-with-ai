...
description: Structuring an agency proposal that wins the engagement and sets correct expectations.
type: sub-section
phase: pre-sales
order: 3
tree: "process"
...
The proposal is the artifact you produce after the [scoping call](/pre-sales/lead-qualification-scoping-calls/) and before the [SOW](/pre-sales/sow-contract-drafting/). It is a sales document — its job is to convince the prospect to pick your agency over alternatives, and to give the economic buyer the materials needed to authorize a purchase.
...
:::tip
Mirror the prospect's language back to them in the executive summary. If they call it "the platform" rather than "the application," your proposal calls it "the platform." This signals that you listened and reduces the cognitive friction of the buying decision.
:::

:::caution
Do not write a proposal without notes from a scoping call. Proposals authored from an RFP alone, with no direct conversation, are guesses dressed up as commitments. If the procurement process forbids pre-bid contact, decline the bid or accept that your win probability is low.
:::
