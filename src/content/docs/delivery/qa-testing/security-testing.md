...
Security testing in QA validates the [secure-development practices](/delivery/development/secure-development-practices/) applied during build. It runs four classes of activity, each targeting a different threat surface and each scaled to engagement risk:
