...
**New to consulting?** Start with Pre-Sales and read in order — the lifecycle is sequential. **Looking for something specific?** Use the sidebar or search. Two cross-lifecycle references — [Deliverables across the lifecycle](/deliverables/) and the [Glossary](/glossary/) — sit at the bottom of the sidebar.
